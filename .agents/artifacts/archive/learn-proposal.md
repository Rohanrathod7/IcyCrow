...
**Verdict:** Save
**Rationale:** Passed all 4 quality gates. It generalizes to any heavy DOM parsing extension, respects MV3 client-side execution, is proven to fix tab freezes (verified via S5 refactor), and is atomic enough to be understood independently.

## 📄 Proposed File Content (For SAVE)
**Target Path:** `.agents/skills/content-script-performance.md`
